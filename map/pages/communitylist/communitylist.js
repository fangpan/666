...
Page({
 ...
 onLoad: function (options) {
   ...
   that.setData({
    ...
    wx.request({
        url:""+pathURL+"/wx/teachingstation/info/"+id+"",
        method:"GET",
        header: {
         'content-type': 'application/json'
        },
        success:function(res){
            var unitName = res.data.teachingStation.unitName;   
            var unitIntroduction = res.data.teachingStation.unitIntroduction ;
            var latitude = res.data.teachingStation.latitude ;
            var longitude = res.data.teachingStation.longitude
            that.setData({
                name : unitName,
            ...
            console.log(res.data.teachingStation)
          }
      });

   wx.request({
        url:""+pathURL+"/wx/scienceuniversity/list?limit=9999&&id="+id+"",
        method:"GET",
        header: {
         'content-type': 'application/json'
        },
...
// 获取缩放等级
 ...
 search: function () {
     ...
     var  pathURL = getApp().globalData.PATH
     wx.request({
        url:""+pathURL+"/wx/scienceuniversity/list?limit=9999&&id="+id+"&&name="+that.data.inputValue+"",
        method:"GET",
        header: {
         'content-type': 'application/json'
        },
