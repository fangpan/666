...
const util = require('../../utils/showModel.js')
const app = getApp()
...
Page({
  ...
  ajax: function(){
   ...
   //获取展教联盟
     wx.request({
          url:""+pathURL+"/wx/exhibitionalliance/list?limit=9999",
          method:"GET",
          header: {
...
//点击标记点跳转
  markertap(e) {
      var id = e.markerId
       wx.navigateTo({
           url: '../resourcdetail/resourcdetail?id='+id+''
      });
  },
 ...
 var pathURL = getApp().globalData.PATH
 wx.request({
        url:""+pathURL+"/wx/exhibitionalliance/list?limit=9999&&name="+that.data.inputValue+"",
        method:"GET",
        header: {
         'content-type': 'application/json'
        },
