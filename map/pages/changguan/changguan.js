...
//展示品牌
  ...
  ajax:function(){
    ...
    //获取特色场馆
     wx.request({
        url:""+pathURL+"/wx/sciencevenues/list?limit=9999",
        method:"GET",
        header: {
 ...
 search: function () {
     ...
     var pathURL = getApp().globalData.PATH
         wx.request({
            url:""+pathURL+"/wx/sciencevenues/list?limit=9999&&name="+that.data.inputValue+"",
            method:"GET",
            header: {
             'content-type': 'application/json'
            },
...
markertap(e) {
     var id = e.markerId
       wx.navigateTo({
           url: '../changguandetail/changguandetail?id='+id+''
         });
  },
