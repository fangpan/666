...
*/
(function(win) {
    var root = win.GV.WEB_ROOT+win.GV.JS_ROOT || location.origin + '/public/js/', //鍦╳ind.js鍔犺浇涔嬪墠瀹氫箟GV.JS_ROOT
        ver = '',
        //瀹氫箟甯哥敤JS缁勪欢鍒悕锛屼娇鐢ㄥ埆鍚嶅姞杞�
        alias = {
    ...
    Wind.css = function(alias/*alias or path*/,callback) {
        ...
        link.rel = 'stylesheet';
        link.href = url;
        link.onload = link.onreadystatechange = function() {//chrome link鏃爋nload浜嬩欢
    ...
    /**
     * 鏇存柊鎴栬€呮坊鍔爅s鍒悕,鍦� Wind.use()璋冪敤鍚嶄娇鐢�
     * @param newalias ,瑕佽缃殑鍒悕瀵硅薄
     */
    ...
    /**
     * 鏇存柊鎴栬€呮坊鍔燾ss鍒悕,鍦� Wind.css()璋冪敤鍚嶄娇鐢�
     * @param newalias ,瑕佽缃殑鍒悕瀵硅薄
     */
